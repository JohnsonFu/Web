                        ...
                        <s:iterator id="item" value="hotellist">
                            ...
                            <tr>
                                <form action="HotelManager.action">
                                    ...
                                    <td class="center"> <s:submit value="查看业务" cssClass="btn btn-primary" method="ShowSingleBusiness"></s:submit></td>
                                    <td class="center"> <s:submit value="结算" cssClass="btn btn-primary" method="ShowSingleList"></s:submit></td>
</form>
                            </tr>
