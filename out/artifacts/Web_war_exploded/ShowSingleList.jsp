            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="ManagerCharts.jsp"><i class="glyphicon glyphicon-folder-open blue"></i><span>查看各店资产</span></a>
                        </li>
        ...
        <div id="content" class="col-lg-10 col-sm-10">
            ...
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-user"></i>酒店结算</h2>
                ...
                <div class="box-content">
                    <table class="table table-striped table-bordered responsive">
                        <thead>
                        <tr>
                            <th class="center">入住人</th>
                            <th class="center">入户时间</th>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td class="center">总金额: <s:property value="totalMoney"></s:property></td>
                            <td class="center"> <s:submit value="结算" cssClass="btn btn-primary" method="payMoney"></s:submit></td>
                        </tr>
