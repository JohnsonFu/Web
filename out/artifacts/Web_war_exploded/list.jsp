...
<div class="container" align="center">
    <table border="1">
        ...
        <s:iterator id="item" value="booklist">
            <tr>
                <s:form action="edit">
                    <th><input type="hidden" name="book.id" value=<s:property value="#item.id"/>><input type="hidden"
                                                                                                        name="book.name"
                                                                                                        value=
                        <s:property value='#item.name'/>>${item.name}</th>
                    <th><input type="hidden" name="book.author" value=<s:property value='#item.author'/>>${item.author}
                    </th>
